...
var raycasterX, raycasterY, raycasterZ;
...
function animate() {
	...
	raycasterX.ray.origin = player.position;
	raycasterY.ray.origin = player.position;
	raycasterZ.ray.origin = player.position;

	var intersectionsX = raycasterX.intersectObjects( objects );
	var intersectionsY = raycasterY.intersectObjects( objects );
	var intersectionsZ = raycasterZ.intersectObjects( objects );

	var isOnObject = intersectionsY.length > 0;
	var isTouchingX = intersectionsX.length > 0;
	var isTouchingZ = intersectionsZ.length > 0;
